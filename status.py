...
app = Client(
    ...
    api_id = int(os.getenv("API_ID", "27957041")),
    api_hash = os.getenv("API_HASH", "2ae1c9912cd2efdecae7f0208994f0b0"),
...
BOT_OWNERS_AND_LOGS = {
    "SVDsinger_bot": {"owner_id": 655594746, "log_group_id": -1002094585538}, # Add more bots and their corresponding owner_id and log_group_id
    ...
    "common": {"log_group_id": -1001975251757},  # Add the common log group ID here    
}
